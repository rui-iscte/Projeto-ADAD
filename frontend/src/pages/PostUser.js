    ...
    <div className="container pt-5 pb-5">
      ...
      <Form onSubmit={handleSubmit}>
        <Form.Group className="mb-3">
          ...
          <Form.Control name="first_name" type="text" pattern="[\p{L}\s]+" placeholder="Enter first name" onChange={handleChange} required />
        </Form.Group>

        <Form.Group className="mb-3">
          <Form.Label>Last Name</Form.Label>
          <Form.Control name="last_name" type="text" pattern="[\p{L}\s]+" placeholder="Enter last name" onChange={handleChange} />
        </Form.Group>

        <Form.Group className="mb-3">
          <Form.Label>Year of Birth</Form.Label>
          <Form.Control name="year_of_birth" type="number" step="0" min="1" placeholder="Enter year of birth" onChange={handleChange} />
        </Form.Group>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control name="reviews" type="text" placeholder="Enter reviews" onChange={handleChange} />
